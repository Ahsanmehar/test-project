...
const Card = ({ data, type, onButtonClick, onSecondaryButtonClick }) => {
  ...
  const cardClasses =
    "group bg-slate-900 rounded-2xl overflow-hidden hover:transform hover:scale-102 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500 flex flex-col";
              ...
              <div className="flex flex-col items-start mb-3">
                ...
                <div className="flex items-baseline space-x-4">
                  <span className="text-base text-slate-400 font-medium">
                    Online: {data.price.online}
                  </span>
                  <span className="text-base text-slate-400 font-medium">
                    Onsite: {data.price.onsite}
                  </span>
                </div>
              </div>
