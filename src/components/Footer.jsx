...
const Footer = () => {
  ...
  const quickLinks = [
    { name: "Courses", path: "/courses", type: "scroll" },
    { name: "Projects", path: "/projects", type: "scroll" },
    { name: "About", path: "/about", type: "scroll" },
    { name: "Journey", path: "/devsum-diaries", type: "scroll" },
  ...
  const socialLinks = [
    {
      ...
      href: "https://www.facebook.com/profile.php?id=61576985506065",
      name: "Facebook",
    },
    {
      icon: <Instagram size={20} />,
      href: "https://www.instagram.com/devsum_/",
      name: "Instagram",
    },
    {
      icon: <Linkedin size={20} />,
      href: "https://www.linkedin.com/company/dev-sum/",
      name: "LinkedIn",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-1 flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <p className="text-slate-300 mb-6 leading-relaxed">
              Empowering future developers through hands-on courses and
              real-world projects. Join our community of learners and start your
